...
abs= ggplot(lv) + geom_point(aes(x = Tid, y = Fox, color = "Fox")) + geom_point(aes(x = Tid, y = Rabbit,color = "Rabbit")) + labs(x = "Time", y = "Antall i bestanden", title = "Lotka-volterra")
ggsave("dode_harer.png", plot = abs)